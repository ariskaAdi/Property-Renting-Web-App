...
const fetchUserSalesReport = async () => {
  ...
  if (!token) {
    console.warn("Token not found during sales report fetch.");
    throw new Error("Authentication required for report access.");
  }
  ...
  try {
    ...
    return (
      <div className="p-8 text-red-500">
        Failed to load sales data. Please ensure you are logged in.
      </div>
    );
  }
}
